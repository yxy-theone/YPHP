		        	...
		        	if(result.success == true){
		        		...
		        		if(articles.length>0){
				    		...
				    		for (var i = 0; i < articles.length; i++) {
				    			articles_dom += '<div class="col-xs-12 col-sm-12 col-md-6"><div class="article-list-box"><div class="article-list-image">';
				    			articles_dom += '<a  class="open-single-frame" target="_blank" href="'+articles[i].url+'">';
				    			...
				    			articles_dom += '</div><h2><a class="open-single-frame" target="_blank" href="'+articles[i].url+'"><span class="entry-title-primary">'+articles[i].title+'</span></a></h2>';
